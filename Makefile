...
pkgdatadir = $(datadir)/kasumi
pkglibdir = $(libdir)/kasumi
pkgincludedir = $(includedir)/kasumi
...
GTK_CFLAGS = -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/X11R6/include -I/usr/include/atk-1.0 -I/usr/include/pango-1.0 -I/usr/include/freetype2 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include  
...
CFLAGS = -g -O2 -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/X11R6/include -I/usr/include/atk-1.0 -I/usr/include/pango-1.0 -I/usr/include/freetype2 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include  
...
kasumi: $(kasumi_OBJECTS) $(kasumi_DEPENDENCIES)
	@rm -f kasumi
	$(CXXLINK) $(kasumi_LDFLAGS) $(kasumi_OBJECTS) $(kasumi_LDADD) $(LIBS)
.cxx.o:
	$(CXXCOMPILE) -c $<
